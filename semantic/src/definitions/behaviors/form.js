      ...
      module = {
        ...
        clear: function() {
          $field.each(function(index, el) {
            ...
            const isCalendar = $calendar.length > 0
        ...
        event: {
          field: {
            keydown: function(event) {
              ...
              const isInDropdown =
                $field.closest(selector.uiDropdown).length > 0
              const keyCode = {
                enter: 13,
                escape: 27
              }
        ...
        set: {
          ...
          defaults: function() {
            $field.each(function(index, el) {
              ...
              const isCheckbox = $el.filter(selector.checkbox).length > 0
              const isDropdown = $parent.is(selector.uiDropdown)
              const value = isCheckbox ? $el.is(':checked') : $el.val()
              if (isDropdown) {
  ...
  $.fn.form.settings = {
    ...
    rules: {
      ...
      match: function(value, identifier, $module) {
        let matchingValue, matchingElement
        if (
