      ...
      module = {
        ...
        get: {
          text: function(templateText, index) {
            ...
            const value = module.get.value(index_)
        ...
        set: {
          barWidth: function(values) {
            ...
            const total = module.helper.sum(values)
            if (total > 100) {
            ...
            if (!module.has.total()) {
              ...
              if (settings.limitValues) {
                module.value = module.value.map(function(value) {
                  return value > 100 ? 100 : module.value < 0 ? 0 : module.value
                })
              }
            }
        ...
        update: {
          ...
          progress: function(values) {
            ...
            const percentCompletes = module.helper
              .forceArray(values)
              .map(function(value) {
                let percentComplete
