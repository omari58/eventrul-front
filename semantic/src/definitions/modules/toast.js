...
;(function($, window, document, undefined) {
  ...
  $.fn.toast = function(parameters) {
    ...
    $allModules.each(function() {
      ...
      const $module = $(this)
      const $toastBox = $('<div/>', { class: settings.className.box })
      let $toast = $('<div/>')
      const $progress = $('<div/>', {
        class: settings.className.progress + ' ' + settings.class
      })
      const $progressBar = $('<div/>', { class: 'bar' })

      const $close = $('<i/>', { class: 'close icon' })
      ...
      module = {
        ...
        create: {
          ...
          toast: function() {
            const $content = $('<div/>').addClass(className.content)
            ...
            const iconClass =
              typeof settings.showIcon === 'string'
                ...
                : ''
            if (iconClass != '') {
              const $icon = $('<i/>').addClass(iconClass + ' ' + className.icon)
